...
> 生成时间：2026-09-16 04:43:41 UTC　·　运行模式：**离线回放 mock（文档基线）**　·　数据源：11 个　·　由 `tools/probe_sentiment_apis.py` 自动生成，请勿手工编辑
...
| 时效新鲜度 | ✅ | 最新记录 2026-09-15（距今 1 天，阈值 ≤3 天） · mock 模式按录制日期判定，实际时效需 --live 复核 |
