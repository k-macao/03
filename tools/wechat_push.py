...
def build_single_wechat_html(now=None):
    ...
    竖版长页面。配色: 浅灰底 + 正文纯黑 + 荧光绿标题；重点文字为荧光绿字 + 黑色底，
    装饰线荧光绿。全部字号偏小。
    ...
    communities = [
        ('🐮', '1', '富途牛牛社区', '多空分歧', 'mixed',
         ...
         '综合站内 3 条热门长帖与讨论 · 最新读取 2026-08-29'),
        ('❄️', '2', '雪球网', '多空分歧', 'mixed',
         '热帖直指“恒指 26,000 关口压力重重，本轮是反弹还是反转”。8 月 6 日恒指跌 1.49% 报 25,530、恒科跌 2.28% 报 4,820 后，球友对半导体“空头撤退股价仍跌”解读为被动出清而非新一轮做空；美债 10 年期约 4.67% 仍压制高估值成长，资金在光通信 / 芯片与红利、内房之间高速轮动。价值派强调：南向 7 月净买入 628.69 亿、今年除 5 月外持续流入，盈利 3%–4% 内生增长与 31,000 点基准目标仍成立，主张高息底仓 + 新质生产力，拒绝在 26,000 附近追高。',
         '短线偏空 · 中期偏多。26,000 失败与成长股出清尚未结束；但南向月度级回流与低估值高息底仓，为中期提供足够安全边际。',
         '综合站内 3 条深度研报与讨论 · 最新读取 2026-08-29'),
        ('🐯', '3', '老虎社区', '偏空', 'bear',
         '跨境账户情绪仍偏弱：8 月 11–12 日港股跌幅明显大于上证（恒指 −1.1%、−0.83% vs 沪指相对抗跌），被解读为外资 trim China exposure 快于内资；美伊和解预期降温、霍尔木兹推升油价，叠加华尔街隔夜科技股回撤，亚洲时段反弹乏力。社区对折价配售、H 股大额募资（中际旭创等）仍敏感，认为股权稀释压制追高意愿；操作共识是继续观望，等待金叉与 25,800 放量收复，短线维持离场信号。',
         '偏空观望。外资定价的离岸市场对地缘与美股映射更敏感，港股“先跌于 A 股”格局未改；在缺乏右侧信号前不宜抄底。',
         '综合站内 3 条热门跨境讨论 · 最新读取 2026-08-29'),
        ('💰', '4', '东方财富港股股吧', '偏空', 'bear',
         '股吧情绪从 8 月初追高迅速切到“迷茫期”：8 月 12 日恒指低开 0.6%、全天低开低走，科网股普跌被视作减仓信号；讨论焦点从“五连阳还能不能追”转为“26,000 失败后会不会回踩 25,200”。内房午后突然拉升（中国金茂涨超 13%、越秀地产涨近 10%）被解读为政策博弈炒作而非趋势反转；消费防御（康师傅、龙湖、华润置地）相对抗跌。多数声音主张先看 25,400 箱体下沿能否守住，跌破再看 24,400 / 23,500。',
         '短线偏空。散户从狂热切换到观望，低开低走与科网兑现共振；内房脉冲难改大盘箱体下修的短线基调。',
         '综合站内 3 条高互动主题帖 · 最新读取 2026-08-29'),
        ('📈', '5', '智通财经互动区', '偏多', 'bull',
         '席位与衍生品视角：8 月 8 日恒指牛熊街货比约 49:51，熊证重货区落在 26,200–26,299、牛证重货区在 25,200–25,299，与现货箱体高度吻合；8 月 11 日街货比约 49.5:50.5，多空几乎打平。盘面结构上，光通信获摩根大通一周内多次加仓中际旭创 H 股（持股升至 15.60%），芯片股 8 月 12 日逆市（中芯 +3%、华虹 +7%）；长线席位继续流向高息、REITs、电信与公用事业。8 月扩容的每周/月度股票期权为对冲 26,000 失败后的波动率提供了工具。',
         '偏多 (结构性机遇)。街货比中性、机构在光通信与高息两端同时加仓，箱体内更适合用期权做结构，而不是裸空指数。',
         '综合站内 3 条专业席位跟踪分析 · 最新读取 2026-08-29'),
        ('🌐', '6', '华尔街见闻社区', '偏多', 'bull',
         '宏观对冲盘聚焦两则新数据：8 月 12 日美国 7 月 CPI 同比 3.4%、核心 2.5%，叠加 7 月非农净减 2.3 万人，显著压低 9 月加息概率，离岸成长估值压力边际缓解；另一面是美伊和解预期降温、油价升至一周高位，霍尔木兹溢价重新定价。社区主流叙事仍是“全球资金从韩日美股拥挤多头再平衡至低估港股 + 国内政策托底”，但强调 26,000 失败后应以防守姿态做多：黄金约 4,400 美元、铜铝锂与高息低贝塔，而不是追互联网贝塔。',
         '中性偏多 (防御姿态做多)。CPI 降温打开估值修复窗口，霍尔木兹与油价则封住上行斜率；适合用高息 + 贵金属底仓承接再平衡资金。',
         '综合站内 3 条宏观深度长文 · 最新读取 2026-08-29'),
        ('🇭🇰', '7', '香港讨论区财经版', '中性', 'neutral',
         '本地炒鬼对 8 月 12 日低开低走并不意外——“又係 26,000 附近派货”。内房午后突然炒作（中国金茂、越秀、绿城）被当成政策消息博弈，多数人表示“睇得、唔好追”。共识仍是港股弱于 A 股、先跌后上，必须等金叉同南向持续净流入先至加仓；配置上继续揽住高息、本地电信、REITs 同公用，地产蓝筹只当短线股息工具。',
         '中性。本土零售维持防守观望，内房脉冲难改仓位结构；右侧金叉出现前不宜激进加仓。',
         '综合站内 3 条粤语热门讨论贴 · 最新读取 2026-08-29'),
        ('🔥', '8', 'LIHKG 连登财经台', '偏空', 'bear',
         '连登交易员认为 8 月初 RSI 逼近 72、三周涨 8.5% 后未能放量突破 26,200–26,500，超买回调已经兑现：8 月 6 日 −1.49%、11 日 −1.1%、12 日 −0.83%。主流策略从“追五连阳”全面切到期权 / 牛熊证做波动率，街货比 49:51 被解读为多空打平、适合两边开仓；硬止损纪律被反复强调。中期仍认资金再平衡，但短线要紧盯 6h/12h ALMA 与 25,200 牛证重货区，失守再减。',
         '短线偏空 (超买回调兑现中)。26,000 失败后波动率交易优于方向单；未站回 25,800–26,000 前，杠杆多头盈亏比不佳。',
         '综合站内 3 条高频交易讨论链 · 最新读取 2026-08-29'),
        ('🥦', '9', '韭圈儿 / 红岸社区', '偏多', 'bull',
         '公募与港股通持仓透视：7 月南向净买入 628.69 亿、6 月 271.11 亿，8 月延续净流入；近一月主力流向资讯科技（+295 亿）、原材料（+224 亿）、医疗保健（+156 亿）。截至 8 月 3 日南向持股市值前十仍是腾讯、建行、工行、中海油、汇丰、中国移动、阿里、中行、中芯、小米。中信海外策略指出外资二季度已由净流出转为净流入，是本轮上行的边际增量。机构共识未改：估值修复 + 科技盈利是 2026 主引擎，31,000 / 34,000 目标仍在；但 26,000 附近已见部分调仓换股，散户狂热降温后更利于机构吸筹。',
         '偏多 (中期基本面驱动)。月度级南向与外资回流比单日指数涨跌更有信息量；箱体震荡是机构完成高低切换的窗口。',
         '综合站内 3 篇机构仓位拆解报告 · 最新读取 2026-08-29'),
        ('🐜', '10', '蚂蚁财富港股社区', '中性', 'neutral',
         '8 月初五连阳时散户港股 ETF 申购与搜索热度冲高，被视作反向指标；经过 26,000 失败与连续回调后，社区狂热明显降温，讨论从“还能不能追”转为“定投要不要暂停”。理财顾问仍主推高息红利、REITs、电信与公用事业作为底仓，提醒不要在箱体上沿加杠杆。反向指标警报部分解除，但基民定投惯性仍在，情绪从极度乐观回到中性偏防守。',
         '中性 (狂热降温)。散户 FOMO 消退降低了短线见顶压力，但尚未出现恐慌性申赎；适合把仓位从追涨切换回定投式防御底仓。',
         '综合站内 3 条基民热评与定投贴 · 最新读取 2026-08-29'),
        ('👾', '11', 'Reddit (r/ChinaStocks)', '中性', 'neutral',
         '英文社区仍把港股当作投资中国核心资产最便利的离岸通道，VIE / ADR 等价性讨论未停。增量话题切到宏观：8 月 12 日美国 CPI 符合预期降温、7 月就业意外净减，降低了美联储 9 月加息的紧迫性；同时霍尔木兹和解预期反复、油价走高，被视作持有中国风险资产的主要外部扰动。阿里巴巴将于 8 月 20 日公布业绩，成为个股层面的观察点。整体仍偏“可投资性 + 事件驱动”，缺少一致的指数多空押注。',
         '中性。外资认可通道与估值，但在地缘与政策细节落地前维持审慎评估，等待 CPI 后续路径与中概业绩季。',
         '综合站内 3 篇外文热门深度分析 · 最新读取 2026-08-29'),
        ('📊', '12', 'TradingView 香港板块', '偏多', 'bull',
         '图表派更新：三周反弹 8.5% 后于 26,000 录得 RSI 72.58 的全程最高读数，成为本轮首个真正超买警报；EMA9/21 交叉约 25,978 / 25,471 仍托住整段升势，MACD 柱状图在高位出现减速。8 月 12 日收 25,440，恰好回踩 9/21 均线带下沿附近。新交易计划：方向仍偏多、原目标已兑现，新作战目标 26,500 / 延伸 27,044，移动止损上移至 25,124；若失守 25,200 牛证重货区则视为箱体下破。长线仍提示：以 28,056 为 2026 高点的均值回归下沿可指向 19,885，每段必须执行 −10% 硬止损。',
         '偏多 (结构完好、战术回调)。超买在 26,000 消化是健康的，均线带未坏；回踩 25,400–25,470 是加仓带，失守 25,124 才改方向。',
         '综合站内 3 套专业技术分析图表与指标 · 最新读取 2026-08-29'),
        ('💎', '13', 'Value Investors Club', '偏多', 'bull',
         '价投私密社区并不把 26,000 失败当成逻辑破坏：港股相对欧美的估值折价、中小盘私有化套利与控股股东折价仍是 2026 主引擎。基准情景维持恒指年底 28,000–29,000、乐观 31,000，盈利增速 3%–4%；8 月国泰君安国际遭母公司约 286 亿港元私有化要约，被当作“折价收窄仍在发生”的活样本。配置不变：高息 + 中资科技 + 本地金融为底仓，REITs / 电信 / 必需消费 / 公用对冲霍尔木兹与再通胀。短线指数位置反而提供更好的安全边际。',
         '偏多 (价投标尺确立)。箱体回撤不改变折价修复路径；私有化与回购仍是中小盘的确定性事件驱动。',
         '综合站内 3 篇顶尖私密价值分析研报 · 最新读取 2026-08-29'),
        ('🐦', '14', 'Twitter / X (FinTwit)', '偏多', 'bull',
         'FinTwit 宏观账户仍把港股标成“再平衡避风港”，但语气从 8 月初的右侧突破转为“26,000 失败后的健康回撤”。7 月 CPI 3.4% + 就业意外疲弱压低加息赔率，被视作离岸中资的估值利好；黄金约 4,400、铜锂继续作为地缘对冲。政策叙事切到北京“及时实施积极政策”表态与一线城市放松限购 / 公积金（8 月 12 日内房脉冲），但批评声音指出政治局只给方向未给细则。技术上 MA50 已站上，关键是守住 25,200–25,470 均线带，再挑战 26,000。',
         '偏多 (国际资本仍在场)。再平衡 + CPI 降温仍是多头底盘；缺的是政策细则与放量收复 26,000，短线应降低进攻斜率。',
         '综合站内 3 条海外基金经理核心观点 · 最新读取 2026-08-29'),
    ]
  ...
  <div style="background:#000;border-top:4px solid {NEON};padding:16px 12px 10px;margin:20px -12px 0;font-size:12px;color:#c8c8c8;line-height:1.9;">
    ...
    <span style="color:#7d838b;font-size:10px;">生成时间：{ts_full} · 24h 内最新可读取内容 · 100K 完整单页版</span>
  </div>
...
def build_articles(source_html=SOURCE_HTML, now=None):
    ...
    构建前先核对当前时间, 正文时间戳使用最新时间。
    推送标题不含 pushplus 或时间, 保持简洁, 同时保留副标题说明。
    """
